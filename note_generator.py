...
SESSION_FILLERS = [
    ...
    "A least-to-most prompting hierarchy was used across targeted programs, with prompts faded as independent responding increased.",
    "Graduated guidance was applied during hands-on tasks, with physical support reduced as the client demonstrated consistent accuracy.",
    "A most-to-least prompting sequence was used to introduce newly targeted skills before shifting toward independent responding.",
    "Time-delay prompting was used across select trials to encourage the client to initiate responses before a prompt was delivered.",
    "Errorless teaching procedures were applied to new targets to minimize incorrect responding during acquisition.",
    "A variable ratio reinforcement schedule was in effect for previously mastered skills to help maintain consistent responding.",
    "Reinforcement was thinned gradually across mastered programs in line with the current treatment plan.",
    "Maintenance probes were conducted on previously mastered targets to confirm skills remained stable over time.",
    "Generalization trials were run across novel materials to assess whether skills transferred beyond the original teaching context.",
    "A brief probe of untaught exemplars was conducted to check for generalization of the target skill.",
    "Data were graphed following the session to visually track trends relative to the client's mastery criteria.",
    "A phase change was considered based on today's data relative to the client's current mastery criteria.",
    "Today's data point continued a stable trend consistent with recent sessions.",
    "An upward trend in correct responding was noted across the last several data points collected for this program.",
    "The session incorporated brief maintenance checks on goals mastered in previous treatment phases.",
    "Staff used a stimulus fading procedure to gradually reduce prompt salience across the session.",
    "A backward chaining procedure was used to teach the multi-step task, with the final step taught first.",
    "Forward chaining was used to teach the sequence, with each step added only after the prior step was mastered.",
    "Task analysis steps were reviewed prior to the session to confirm the sequence remained appropriate for the client's current skill level.",
    "A brief functional communication check was conducted at the start of the session to confirm the client's communication system was accessible.",
    "The client's communication device was checked for functionality prior to the start of programming.",
    "Staff confirmed all necessary materials and data sheets were available before the session began.",
    "A visual schedule was used throughout the session to support the client's understanding of the sequence of activities.",
    "First-then language was used to support the client's understanding of task expectations and access to reinforcement.",
    "A token board was used throughout the session to support delayed reinforcement for sustained engagement.",
    "Contingent access to a preferred activity was used to reinforce completion of less-preferred tasks.",
    "Differential reinforcement was applied to strengthen appropriate replacement behavior over the identified target behavior.",
    "Noncontingent access to preferred items was provided briefly at the start of the session to support engagement.",
    "A brief demand fading procedure was used to gradually increase task difficulty across the session.",
    "Staff monitored latency to respond across trials to track changes in the client's processing time.",
    "Inter-trial intervals were kept consistent to support accurate comparison of responding across the session.",
    "A discrete trial format was used for select programs, while other targets were embedded within more naturalistic routines.",
    "Natural environment teaching was used to capture learning opportunities as they arose during less structured portions of the session.",
    "Incidental teaching strategies were used to expand on the client's spontaneous initiations during play.",
    "Staff followed the client's lead during play-based portions of the session to identify additional teaching opportunities.",
    "A structured play routine was used to target turn-taking and joint attention alongside the client's primary goals.",
    "The session included brief social opportunities with peers or siblings when available, consistent with current programming.",
    "Staff modeled appropriate play skills before prompting the client to imitate the modeled sequence.",
    "Video modeling was used to introduce a new skill prior to hands-on practice during the session.",
    "A brief warm-up activity using mastered skills was used to start the session before introducing newer targets.",
    "The session concluded with a review of mastered skills to end on a high rate of reinforcement.",
    "Staff documented specific antecedent and consequence events for each occurrence of a target behavior during the session.",
    "A brief functional analysis probe was embedded in the session to further clarify the function of the target behavior.",
    "Staff implemented the crisis prevention protocol outlined in the client's behavior intervention plan when applicable.",
    "A safety check of the immediate environment was completed before beginning programming that involved movement around the space.",
    "Materials with choking or safety hazards were removed from the workspace prior to the start of the session.",
    "Staff maintained a clear line of sight to the client throughout the session as outlined in the safety plan.",
    "A designated safe space was made available to the client throughout the session as outlined in the behavior support plan.",
    "The client's individualized reinforcement inventory was reviewed prior to the session to confirm current preferences.",
    "A brief preference assessment was conducted at the start of the session to identify effective reinforcers for that day.",
    "A paired-stimulus preference assessment informed which items were made available for reinforcement during the session.",
    "Reinforcer potency was monitored throughout the session, with items rotated as needed to maintain motivation.",
    "Staff used behavior-specific praise to clearly identify which responses were being reinforced.",
    "Instructions were delivered using consistent wording across staff to reduce variability in the client's responding.",
    "A brief coaching conversation with the caregiver took place at the end of the session to review today's progress.",
    "Caregiver questions about today's session were addressed briefly at pickup, with more detailed discussion deferred to the next scheduled training session.",
    "Session notes from today will be shared with the treatment team to support continuity of care across providers.",
    "The client's response to today's session will be considered when planning next steps in programming.",
    "Staff reviewed the client's individualized treatment plan prior to the session to confirm current goals and procedures.",
    "A brief review of yesterday's data informed which programs received priority focus during today's session.",
    "The order in which programs were presented was varied slightly from recent sessions to support generalization.",
    "Staff used a consistent greeting and session opening routine to help orient the client to the start of programming.",
    "A closing routine, including a brief recap and preferred activity, was used to end the session on a positive note.",
    "The client transitioned into the session with minimal support, consistent with recent sessions.",
    "Staff arranged the environment to reduce competing stimuli during portions of the session requiring sustained attention.",
    "A quiet transition warning was provided before each major activity change during the session.",
    "The client was given a brief choice of activity order at the start of the session to support engagement.",
    "Staff tracked the number of independent versus prompted responses across each targeted program.",
    "A running tally of correct responses was kept throughout the session to support real-time data review.",
    "Percentage of independent responding was calculated at the end of the session for each active program.",
    "Today's session data will be compared against the client's most recent progress summary to evaluate trends.",
    "Staff noted the specific prompt level required for each trial to inform future prompt-fading decisions.",
    "A brief interobserver agreement check was conducted with a second staff member during part of the session.",
    "The client's engagement was distributed across a mix of preferred and less-preferred tasks throughout the session.",
    "Staff alternated between high- and low-preference tasks to maintain motivation across the session.",
    "A brief request for a break was honored promptly to reinforce appropriate communication of the need for a pause.",
    "The client's use of a break card or similar communication tool was reinforced consistently throughout the session.",
    "Staff used planned ignoring for low-level attention-maintained behavior while continuing to reinforce appropriate alternatives.",
    "A response cost procedure, as outlined in the treatment plan, was applied consistently when applicable during the session.",
    "Staff confirmed the client's current medical and dietary considerations were accounted for in today's reinforcement choices.",
    "The session schedule was adjusted slightly to accommodate the client's arrival time without disrupting overall programming.",
    "Staff coordinated briefly with school or daycare staff, when applicable, to align strategies across settings.",
    "A brief written summary of today's session will be made available to the family upon request.",
    "The client's overall attendance and engagement pattern over recent sessions was considered when planning today's programming.",
]
...
CAREGIVER_FILLERS = [
    ...
    "The BCBA reviewed how to deliver instructions using a calm, neutral tone to support consistent responding from the client.",
    "The caregiver was walked through how to identify the antecedent, behavior, and consequence of a recent incident at home.",
    "The BCBA introduced a simple data sheet the caregiver can use to track occurrences of the target behavior at home.",
    "The caregiver practiced identifying replacement behaviors that could serve the same function as the target behavior.",
    "A brief overview of how to fade physical prompts at home was provided, matching the approach used during sessions.",
    "The BCBA demonstrated how to deliver reinforcement immediately following a desired response to strengthen the association.",
    "The caregiver and BCBA reviewed how to set up a designated work area at home to support focused practice of target skills.",
    "Strategies for maintaining consistency between two caregivers in the home were discussed to reduce mixed messages to the client.",
    "The BCBA reviewed how to respond if the client engages in the target behavior in a public setting.",
    "The caregiver was shown how to use a visual first-then board to support transitions at home.",
    "A brief discussion covered how to build in short breaks during homework or chore routines to support sustained engagement.",
    "The BCBA and caregiver discussed how to introduce a new food using a gradual exposure approach.",
    "The caregiver was given guidance on how to respond calmly and consistently during a targeted behavior to avoid inadvertently reinforcing it.",
    "The BCBA explained the difference between planned ignoring and simply not responding, and when each is appropriate.",
    "The caregiver and BCBA reviewed how to prompt the client to use words or a communication device instead of engaging in problem behavior.",
    "A brief discussion covered how to introduce choices into daily routines to increase the client's sense of control.",
    "The BCBA reviewed how to gradually increase the length of time the client is expected to wait for a preferred item.",
    "The caregiver was coached on how to deliver praise immediately and specifically following a desired response.",
    "The BCBA discussed how to prepare the client in advance for changes to the daily schedule.",
    "The caregiver and BCBA discussed how to introduce a reward chart appropriate for the client's current age and skill level.",
    "A brief conversation covered how siblings can be included in reinforcement routines without disrupting the client's programming.",
    "The BCBA walked through how to use simple, consistent language when giving directions at home.",
    "The caregiver was shown how to break a multi-step task into smaller, more manageable steps.",
    "The BCBA and caregiver discussed how to recognize early signs that a transition may be difficult for the client.",
    "A brief demonstration covered how to model a skill before prompting the client to attempt it independently.",
    "The caregiver asked about managing screen time transitions, and a few concrete strategies were discussed.",
    "The BCBA reviewed how to gradually reduce reliance on a preferred item once a new skill has been established.",
    "The caregiver and BCBA discussed how to prepare for upcoming travel or changes in the family's routine.",
    "A short discussion covered how to keep a consistent bedtime routine to support the client's overall regulation.",
    "The BCBA offered guidance on how to respond if the client tests a newly introduced limit or expectation.",
    "The caregiver was encouraged to pair verbal praise with a preferred activity to strengthen newly acquired skills.",
    "The BCBA and caregiver reviewed how to use a visual timer to support waiting during less structured activities.",
    "A brief conversation addressed how to handle questions or comments from extended family about the client's programming.",
    "The caregiver was shown how to prompt appropriate greetings and social responses during family gatherings.",
    "The BCBA discussed how to identify which reinforcers are most effective at different times of day.",
    "The caregiver and BCBA reviewed how to document brief notes about behavior at home to share at the next session.",
    "A short discussion covered how to introduce a new caregiver or babysitter to the client's current routines and strategies.",
    "The BCBA reviewed how to use countdown warnings to prepare the client for the end of a preferred activity.",
    "The caregiver asked about managing behavior during grocery shopping, and a few practical strategies were discussed.",
    "The BCBA and caregiver discussed how to keep instructions consistent across both parents to reduce confusion for the client.",
    "A brief overview was provided on how to recognize the difference between escape-maintained and attention-maintained behavior.",
    "The caregiver was shown how to set up a simple token economy using materials already available at home.",
    "The BCBA discussed how to gradually increase independence during self-care routines such as dressing or brushing teeth.",
    "The caregiver and BCBA reviewed how to respond to repetitive questions in a way that reinforces appropriate communication.",
    "A brief conversation covered how to support the client during doctor or dentist visits using strategies from sessions.",
    "The BCBA offered suggestions for keeping the client engaged during longer car rides.",
    "The caregiver was coached on how to use a calm voice and simple redirection when the client displays early signs of escalating behavior.",
    "The BCBA and caregiver discussed how to introduce structured chores appropriate for the client's current skill level.",
    "A short discussion covered how to build in preferred activities as natural reinforcement throughout the day.",
    "The caregiver asked about nighttime waking, and the BCBA offered a few strategies to discuss further with the client's care team.",
    "The BCBA reviewed how to prompt the client to request help rather than engaging in problem behavior when a task is difficult.",
    "The caregiver and BCBA discussed how to maintain consistency in strategies when the client is cared for by a relative.",
    "A brief overview covered how to use a picture schedule to support the client's understanding of the daily routine.",
    "The BCBA discussed how to gradually introduce new peers or playdates in a structured, low-pressure way.",
    "The caregiver was shown how to reinforce the client's attempts at a skill, not just fully independent responses.",
    "The BCBA and caregiver reviewed how to keep a consistent response to tantrums across different settings and caregivers.",
    "A brief conversation addressed how to support the client's participation in family meals.",
    "The caregiver asked about managing behavior in the car, and a few strategies specific to that setting were discussed.",
    "The BCBA reviewed how to gradually fade the use of a highly preferred item once a skill has generalized.",
    "The caregiver and BCBA discussed how to prepare the client for a substitute caregiver or change in routine.",
    "A short discussion covered how to recognize and reinforce spontaneous communication attempts throughout the day.",
]
