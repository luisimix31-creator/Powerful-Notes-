...
CONNECTORS = ["Additionally, ", "During the session, ", "As part of programming, ", "At the same time, ", "Alongside this, ", ""]
...
SESSION_ANTECEDENT_TEMPLATES = [
    "These behaviors were most commonly preceded by {antecedents}.",
    "Antecedent conditions associated with these behaviors included {antecedents}.",
    "Occurrences were most often triggered by {antecedents}.",
    "Common antecedents noted prior to these behaviors included {antecedents}.",
]
...
SESSION_FILLERS = [
    "Reinforcement was delivered on a schedule individualized to the client's current level of skill acquisition and behavioral needs.",
    "Session pacing and activity selection were adjusted in real time based on the client's rate of responding to maximize learning opportunities.",
    "Ongoing progress will continue to be monitored across sessions to inform any necessary adjustments to the treatment plan.",
    "Data collected today were reviewed with an emphasis on identifying trends relevant to program mastery criteria and behavior reduction goals.",
    "Preferred items and activities were incorporated throughout the session as reinforcement to increase the rate of correct and independent responding.",
    "The client's response to intervention was largely consistent with previously observed patterns.",
    "Environmental arrangements, including seating and materials placement, were structured to support on-task responding and minimize distractions.",
    "Treatment fidelity was maintained throughout the session in accordance with the current behavior intervention plan.",
    "Generalization of targeted skills across materials, prompts, and settings continues to be a focus of ongoing programming.",
    "The session was conducted in accordance with the goals outlined in the client's individualized treatment plan.",
    "Caregiver collaboration remains a component of the overall treatment approach to support consistency across settings.",
    "Findings from this session will be incorporated into the client's ongoing progress summary for the current treatment period.",
    "Materials were rotated throughout the session to reduce satiation on any single reinforcer.",
    "The prompting hierarchy was adjusted across trials to promote independent responding wherever possible.",
    "Brief movement and sensory breaks were built into the session to reduce the likelihood of problem behavior and support continued participation.",
    "The client transitioned between activities with varying degrees of support, and transition cues were used to signal upcoming changes.",
    "Rapport-building activities were included at the start of the session to support responding during subsequent programming.",
    "Antecedent strategies were arranged proactively across the session to reduce the likelihood of target behaviors.",
    "The pace and difficulty of tasks were adjusted throughout the session to maintain a consistent rate of correct responding.",
    "Reinforcer preference was informally assessed at the start of the session to guide item selection during programming.",
    "The client's daily schedule and any relevant changes at home or school were reviewed prior to the start of programming.",
    "Notes from the previous session were reviewed to maintain continuity in programming and intervention strategies.",
    "Feedback on the client's performance was documented across programs to guide the next session's planning.",
    "The session incorporated a mix of structured teaching trials and more naturalistic learning opportunities.",
    "Token or point systems, where applicable, were reviewed with the client at natural points throughout the session.",
    "The client's rate of responding and occurrence of target behaviors were monitored throughout the session alongside formal data collection.",
    "Coordination with other members of the client's care team will continue to support consistency of strategies across settings.",
    "Any safety-relevant observations from the session were noted for follow-up as part of ongoing case management.",
    "The treatment plan and behavior intervention plan will continue to be reviewed periodically to ensure goals remain appropriate.",
    "Today's session contributes to the broader dataset used to evaluate the client's overall trajectory of progress.",
    "The client's response across programs and behaviors was consistent with expectations for this stage of treatment.",
    "Staff continued to build rapport with the client throughout the session to support responding during programming.",
    "Reinforcer variety was maintained across the session to reduce the likelihood of satiation on any single item.",
    "The session layout and materials were arranged in advance to support efficient transitions between programs and activities.",
    "Progress across all targeted programs and behaviors will continue to be summarized for the client's ongoing treatment record.",
    "The client was given brief choices throughout the session to support independent selection of activity materials.",
    "Consistency between today's session and prior sessions was maintained wherever possible to support the client's progress.",
    "The physical space was arranged ahead of time to reduce clutter and support on-task responding.",
    "A brief check-in at the start of the session was used to review any relevant changes prior to beginning programming.",
    "The client was given short breaks between demanding tasks to help maintain a steady pace throughout the session.",
    "Instructions were kept short and clear throughout the session to increase the likelihood of correct responding.",
    "The order of activities was adjusted partway through the session based on the client's rate of responding to programming.",
    "A few minutes at the end of the session were used to review the day's progress with the client.",
    "The client's preferences for materials and activities were taken into account when planning today's session.",
    "Verbal praise was paired with tangible reinforcement throughout the session to strengthen desired responses.",
    "The session included brief opportunities for the client to make choices between two or more activities.",
    "Staff checked in periodically to confirm the client responded correctly to instructions before moving to the next task.",
    "A visual timer was used at points during the session to help the client anticipate upcoming transitions.",
    "The client's rate of responding was compared at the start and end of the session to inform pacing for future sessions.",
    "Materials were introduced gradually throughout the session, with response rates monitored closely early in the session.",
    "The session was structured with a mix of easier and more challenging tasks to maintain a consistent rate of correct responding.",
    "Staff remained close by during less structured portions of the session to monitor for safety.",
    "The client's communication attempts throughout the session, verbal and nonverbal, were acknowledged and reinforced.",
    "A short cool-down activity was used near the end of the session to support an orderly transition out of the session.",
    "The session took place in a quiet area to help minimize outside distractions during structured tasks.",
    "Staff used consistent language across the session when giving instructions to reduce errors in responding.",
    "A brief movement break was provided midway through the session to support continued participation in programming.",
]
...
ASSESSMENT_FILLERS = [
    "Findings from this assessment will be used to guide the development of the client's individualized treatment plan.",
    "This report reflects the client's presentation at the time of assessment and may be updated as new information becomes available.",
    "The assessment process included careful review of the client's developmental and treatment history where available.",
    "Caregiver input was incorporated throughout the assessment process to ensure recommendations reflect the family's priorities.",
    "The BCBA considered the client's current environment and daily routines when developing recommendations.",
    "Recommendations outlined in this report are intended to be reviewed and adjusted as treatment progresses.",
    "This assessment was conducted in accordance with professional and ethical guidelines for behavior-analytic evaluation.",
    "The information gathered during this assessment will inform goal selection and prioritization going forward.",
    "Findings were considered within the context of the client's overall developmental profile.",
    "The BCBA will continue to monitor the client's progress and adjust recommendations as needed over time.",
    "This report is intended for use by the treatment team and other relevant stakeholders involved in the client's care.",
    "Consideration was given to the client's strengths, in addition to identified areas of need, when developing recommendations.",
    "The assessment findings are consistent with information gathered from multiple sources, including caregiver report and direct observation.",
    "Recommendations reflect current best practices in the field of Applied Behavior Analysis.",
    "The client's response to previous intervention, where applicable, was considered as part of this evaluation.",
    "This report will be shared with the family and relevant members of the care team following completion.",
    "The BCBA remains available to answer any questions regarding the findings or recommendations outlined in this report.",
    "Environmental factors relevant to the client's presentation were considered throughout the assessment process.",
    "The assessment took into account the client's current level of functioning across multiple domains.",
    "Where appropriate, standardized and informal assessment tools were used to supplement observational data.",
    "The findings outlined in this report represent a point-in-time evaluation and are subject to change.",
    "This report will serve as a reference point for evaluating the client's progress going forward.",
    "The BCBA collaborated with the family to ensure recommendations are feasible within the home and community setting.",
    "Ongoing communication with the family will help ensure recommendations remain aligned with the client's needs.",
    "The scope of this assessment was determined based on the referral concern and available background information.",
    "Assessment results were reviewed collaboratively with relevant members of the client's care team where applicable.",
    "The BCBA will reassess recommendations periodically to reflect the client's ongoing development and progress.",
    "This report reflects a comprehensive review of available information at the time of evaluation.",
    "Findings from this report will be incorporated into the client's broader clinical record.",
    "The client's overall presentation during the assessment period was considered representative of typical functioning.",
    "Additional information may be gathered in future sessions to further refine treatment recommendations.",
    "The BCBA prioritized recommendations based on the client's safety, functioning, and quality of life.",
    "This evaluation considered input from caregivers regarding the client's behavior across multiple settings.",
    "The BCBA will continue to coordinate with other providers involved in the client's care as appropriate.",
    "Recommendations in this report are intended to be individualized and responsive to the client's specific needs.",
    "The BCBA reviewed available records to identify any prior interventions or evaluations relevant to current planning.",
    "Observations were conducted across more than one setting where possible to capture a representative picture of the client's presentation.",
    "The assessment process allowed the BCBA to build initial rapport with the client and family ahead of treatment planning.",
    "Caregivers were asked to describe daily routines in detail to help identify natural opportunities for intervention.",
    "The BCBA noted the client's current communication abilities as part of the overall picture gathered during this evaluation.",
    "Sensory preferences and aversions reported by the caregiver were noted for consideration in future programming.",
    "The client's medical and developmental history, where available, was reviewed as part of this evaluation.",
    "Information gathered during this assessment will help determine appropriate goal sequencing for early treatment.",
    "The BCBA discussed the assessment process with the family to ensure a shared understanding of next steps.",
    "Preliminary observations of the client's play and social behavior were noted during the course of this evaluation.",
    "The family's goals and priorities for treatment were discussed and will be incorporated into future planning.",
    "This evaluation considered the client's functioning relative to same-age peers where relevant information was available.",
    "The BCBA will use the findings of this report to prioritize which goals to address first in early sessions.",
    "Recommendations account for practical considerations such as scheduling and family availability where known.",
    "The assessment reflects a snapshot of the client's current needs and is expected to evolve as treatment begins.",
    "Where possible, the BCBA gathered examples of specific situations to better understand the function of reported behaviors.",
    "The family was given an opportunity to ask questions about the assessment process and proposed next steps.",
    "This report will be used alongside ongoing clinical judgment to guide the earliest phases of treatment.",
    "The BCBA considered cultural and family context when developing recommendations included in this report.",
    "Findings support the need for an individualized approach tailored to the client's specific presentation.",
]
